...
DROP USER IF EXISTS test_user_42;
...
-- Create row policy for other user
CREATE USER test_user_42 IDENTIFIED WITH plaintext_password BY 'user1';
CREATE ROW POLICY test_filter_policy ON test_table USING (n % 5) < 3 TO test_user_42;
